package com.chananel.order;

import com.chananel.order.client.OAuth2InterceptedFeignConfiguration;
import com.chananel.order.config.ApplicationProperties;
import com.chananel.order.config.DefaultProfileUtil;
...
public class OrderApp {
    ...
    public OrderApp(Environment env) {
        this.env = env;
    }
